...
namespace Aliencube.Forem.DevTo.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the ArticleIndex class.
        /// </summary>
        public ArticleIndex()
        {
            CustomInit();
        ...
        /// time</param>
        public ArticleIndex(string typeOfProperty, int id, string title, string description, string coverImage, string readablePublishDate, string socialImage, IList<string> tagList, string tags, string slug, string path, string url, string canonicalUrl, int commentsCount, int positiveReactionsCount, int publicReactionsCount, System.DateTime createdAt, System.DateTime editedAt, System.DateTime crosspostedAt, System.DateTime publishedAt, System.DateTime lastCommentAt, System.DateTime publishedTimestamp, SharedUser user, SharedOrganization organization = default(SharedOrganization), ArticleFlareTag flareTag = default(ArticleFlareTag))
        {
